/* wrap line by gulp-twoside for providing twoside module*/; (function() {var ts = twoside('peasy/karma/logicpeasy.js'), require = ts.require, exports = ts.exports, module = ts.module; 
...
/* wrap line by gulp-twoside for providing twoside module*/; (function() {var ts = twoside('peasy/karma/peasy.js'), require = ts.require, exports = ts.exports, module = ts.module; 
...
/* wrap line by gulp-twoside for providing twoside module*/; (function() {var ts = twoside('peasy/karma/samples-arithmatic.js'), require = ts.require, exports = ts.exports, module = ts.module; 
...
/* wrap line by gulp-twoside for providing twoside module*/; (function() {var ts = twoside('peasy/karma/samples-arithmatic2.js'), require = ts.require, exports = ts.exports, module = ts.module; 
...
/* wrap line by gulp-twoside for providing twoside module*/; (function() {var ts = twoside('peasy/karma/samples-dsl.js'), require = ts.require, exports = ts.exports, module = ts.module; 
