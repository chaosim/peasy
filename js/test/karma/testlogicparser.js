...
if (typeof window === 'object') { ts = twoside('peasy/test/karma/testlogicparser.js'), require = ts.require, exports = ts.exports, module = ts.module;} 
(function(require, exports, module) {
var Parser, Trail, cons, uarray, uobject, vari, _ref,
  __slice = [].slice;

_ref = require('../../logicparser'), vari = _ref.vari, cons = _ref.cons, uobject = _ref.uobject, uarray = _ref.uarray, Trail = _ref.Trail, Parser = _ref.Parser;
