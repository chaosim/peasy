...
if (typeof window === 'object') {
  _ref = twoside('/deprecated/nonmodularpeasy'), require = _ref.require, exports = _ref.exports, module = _ref.module;
}
...
(function(require, exports, module) {
  ...
  exports.addParentChildrens = function(grammar, parentChildren) {
    var children, list, map, name, parent, _i, _len;
    map = grammar.parentToChildren != null ? grammar.parentToChildren : grammar.parentToChildren = {};
    for (parent in parentChildren) {
      children = parentChildren[parent];
      list = map[parent] != null ? map[parent] : map[parent] = [];
  ...
  exports.addRecursiveCircles = function() {
    var circle, grammar, i, j, length, list, map, name, parent, recursiveCircles, _i, _len;
  ...
  exports.recursive = recursive = function(symbol) {
    ...
    return function(start) {
      var child, hash, m, result, _i, _j, _len, _len1, _ref1, _ref2;
  ...
  return exports.setcursor = exports.setcur = function(pos) {
    return cursor = pos;
  };
