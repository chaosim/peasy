...
(function() {
  var ObjecttoString, autoRecursive, computeLeftRecursives, cursor, followIdentifierLetter_, functionCache, grammar, hasOwnProperty, identifierLetter, identifierLetter_, isIdentifierLetter, isRule, isString, literal, literal_, memo, memoAutoRecursive, memoRules, memorize, memorizedRecursivs, originalRules, parseCache, recursive, recursiveRules, setMemoTag, setMemorizeRules, symbolDescedentsMap, symbolToTagMap, tags, text, textLength,
    __slice = [].slice,
  ...
  exports.recursive = recursive = function(symbol) {
    return function(start) {
      var child, hash, m, result, rule, _i, _j, _len, _len1, _ref, _ref1, _ref2;
  ...
  exports.autoComputeLeftRecursives = computeLeftRecursives = function(grammar) {
    var appendToPaths, circle, circles, currentLeftHand, descendents, i, length, meetTable, memorized, parentToChildren, path, paths, pathsCount, sym, symbol, symbolPathsMap, _fn, _i, _j, _len, _ref;
    ...
    for (symbol in grammar) {
      ...
      meetTable = {};
      meetTable[symbol] = true;
      paths = (_ref = symbolPathsMap[symbol]) != null ? _ref : symbolPathsMap[symbol] = [[symbol]];
  ...
  autoRecursive = function(symbol) {
    return function(start) {
      var child, hash, m, memoRule, result, rule, _i, _j, _len, _len1, _ref, _ref1, _ref2;
