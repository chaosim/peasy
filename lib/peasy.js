...
(function() {
  var char, hasOwnProperty, isMatcher, memorize, parse, recursive, setMemoTag,
  ...
  recursive = function(info, rules, symbol) {
    ...
    return function(start) {
      var callPath, hash, m, result, _base, _base1, _ref, _ref1;
      ...
      if (__indexOf.call(callPath, symbol) < 0) {
        ...
        m = (_ref1 = (_base1 = rules.parseCache)[hash]) != null ? _ref1 : _base1[hash] = [void 0, start];
        while (1) {
          result = rule(start);
          if (!result) {
            result = m[0];
  ...
  exports.char = char = function(info, c) {
    return function(start) {
  ...
  parse = function(text) {
    ...
    makeGrammar = function(info) {
      ...
      return exports.setupGrammar(info, rules);
    };
    grammar = makeGrammar({
      data: text,
      cursor: 0
